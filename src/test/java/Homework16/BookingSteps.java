...
public class BookingSteps {
    ...
    @Given("в ресторане есть столик номер {int} вместимостью {int} человека")
    public void вРесторанеЕстьСтоликНомер(int tableNumber, int capacity) {
    ...
    @When("гость забронировал столик на {int} человека")
    public void гостьЗабронировалСтолик_Человека(int guests) {
        System.out.println("Гость бронирует столик на " + guests + " человек");
        // Заглушка
    }

    @When("гость бронирует столик на {int} человек")
    public void гостьБронируетСтолик(int guests) {
        System.out.println("Гость бронирует столик на " + guests + " человек");
        // Заглушка
    }

    @When("гость бронирует столик на {int} человека")
    public void гостьБронируетСтолик_Человека(int guests) {
        System.out.println("Гость бронирует столик на " + guests + " человек");
        // Заглушка
    }
    ...
    public void клиентПолучаетОтказВБронировании() {
        System.out.println("Клиент получает отказ в бронировании");
        // Заглушка
    }
